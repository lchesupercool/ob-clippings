---
title: "[public] thoughts on a typesafe coding agent"
...
![Thoughts on a TypeSafe coding agent](../../assets/thoughts-on-a-typesafe-coding-agent/cover.png)
...
- There are a whole bunch of projects that people cook up that ideally help agents, but in reality don’t
  - Example: <https://github.com/rtk-ai/rtk>
...
- Similar to claude skill hooks: <https://code.claude.com/docs/en/hooks#hooks-in-skills-and-agents> but more powerful
  - Last I checked, these permanently add the hook into the session

### **Recursive language models**

- See <https://alexzhang13.github.io/blog/2025/rlm/>
...
- SLOP: A breakdown of coding agent subtasks
  - ![Document image 1](../../assets/thoughts-on-a-typesafe-coding-agent/doc-image-1.png)
...
- I’ve been noticing a bit of a pattern in some recent popular-ish agent workflows:
  - <https://x.com/xpasky/status/2073298979203211628>
    ...
    - ![Image](../../assets/thoughts-on-a-typesafe-coding-agent/doc-image-2.jpg)
  - <https://x.com/geoffreylitt/status/2072522251300409556>
    - “Understanding is the new bottleneck”
    - ![Image](../../assets/thoughts-on-a-typesafe-coding-agent/doc-image-3.jpg)
  - <https://x.com/samhogan/status/2071608749429829858>
    - Creating evals in the background
    - ![Document image 4](../../assets/thoughts-on-a-typesafe-coding-agent/doc-image-4.png)
  - <https://x.com/trq212/status/2090884854590382515>
    - ELI5 skill
    - ![Document image 5](../../assets/thoughts-on-a-typesafe-coding-agent/doc-image-5.png)
...
![Document image 6](../../assets/thoughts-on-a-typesafe-coding-agent/doc-image-6.png)

---

Source: [Diogo Almeida on X](https://x.com/completeskeptic/status/2101894250401271876?s=52)  
Canonical: [Public Google Doc](https://docs.google.com/document/d/1G61uUB0FifUnmmrPzFQojZ3KpczYKmXGpgEXDJ2l_Zg/edit?tab=t.0)  
Saved: 2026-09-22 14:12:19 +0800
