...
![Designing loops with Fable 5](../../assets/designing-loops-with-fable-5/cover.jpg)
...
It’s a bit like [@karpathy](https://x.com/karpathy)'s autoresearch project: it tests the ability of an agent to edit basic training code (a single `train_gpt.py` file), launch training, poll the log, read the score, and decide what experiment to run next.
...
Source: [X status](https://x.com/RLanceMartin/status/2064397389189071163)  
Canonical: [X article](https://x.com/RLanceMartin/article/2064380553919676416)
