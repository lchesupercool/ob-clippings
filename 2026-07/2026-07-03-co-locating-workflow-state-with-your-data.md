...
![application-level bookkeeping code example](../../assets/co-locating-workflow-state-with-your-data/image-01.png)
...
![workflow idempotency code example](../../assets/co-locating-workflow-state-with-your-data/image-02.png)
...
![transactional outbox pattern SQL example](../../assets/co-locating-workflow-state-with-your-data/image-03.png)
...
![DBOS transactional outbox pattern atomicity example](../../assets/co-locating-workflow-state-with-your-data/image-04.png)
