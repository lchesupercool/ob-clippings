...
clipped: "2026-05-05T13:56:08"
tags:
  - clipping
  - ai-agents
  - coding-agents
  - agent-skills
cover: "../assets/agent-skills-addy-osmani/agent-skills-addy-osmani-cover.jpg"
---

![](../../assets/agent-skills-addy-osmani/agent-skills-addy-osmani-cover.jpg)

# Agent Skills

来源：[原文](https://addyosmani.com/blog/agent-skills/)
...
这篇文章的核心是：AI coding agent 默认会走“最快完成任务”的路线，容易跳过 spec、测试、review、验证证据和范围控制；Agent Skills 试图把高级工程师的工程纪律编码成 agent 必须执行的工作流。关键设计包括：process over prose、anti-rationalization tables、verification as exit criterion、progressive disclosure，以及严格 scope discipline。
