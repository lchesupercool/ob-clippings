...
![Cover image for 5 PostgreSQL locking behaviors that trip people up](../../assets/5-postgresql-locking-behaviors-that-trip-people-up/image-01.png)
...
[![Diagram showing subsequent SELECTs also forced to wait in the lock queue](../../assets/5-postgresql-locking-behaviors-that-trip-people-up/image-02.png)](../../assets/5-postgresql-locking-behaviors-that-trip-people-up/image-02.png)
