---
title: "Supabase将数据库变成AI一等公民"
source: "https://mp.weixin.qq.com/s/8e4OKPqWx5tY2xTtwgavGw"
author: "digoal"
account: "digoal德哥"
published: "2026-05-28 00:00"
saved: "2026-05-28"
tags: [clipping, wechat, supabase, mcp, database, ai]
---

# Supabase将数据库变成AI一等公民

原创：digoal｜digoal德哥｜2026年5月28日 00:00｜浙江

![封面](../../assets/supabase-ai-first-class-database/cover.jpg)

> 自然语言正在成为新的SQL，而MCP协议决定了谁能拿到这张船票。

视频讲解如上，欢迎订阅。2026年5月，Supabase官方集成进ChatGPT。表面看，这是一个“便利性提升”——开发者可以在ChatGPT里直接跑SQL、部署边缘函数。但这个事件的分量，远不止于此。
...
![Supabase MCP 工具](../../assets/supabase-ai-first-class-database/mcp-tools.png)
