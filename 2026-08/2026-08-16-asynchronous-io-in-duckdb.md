...
As usual, things changed. We realized that DuckDB's architecture was a great fit for querying remotely stored large-scale datasets, such as data lakes (e.g., [DuckLake](https://ducklake.select/)). Since [May this year](https://duckdb.org/2026/05/12/quack-remote-protocol), we can even run DuckDB as a server using the [Quack protocol](https://duckdb.org/quack). The original expectation of data files sitting on a local SSD therefore no longer always holds.
...
![Synchronous read](../../assets/duckdb-asynchronous-io/sync-light.svg)
![Synchronous read](../../assets/duckdb-asynchronous-io/sync-dark.svg)
*Synchronous read*
...
> Asynchronous I/O will be used by default from the next major DuckDB version, v2.0, released [in the fall](https://duckdb.org/release_calendar).
...
![Asynchronous read](../../assets/duckdb-asynchronous-io/async-light.svg)
![Asynchronous read](../../assets/duckdb-asynchronous-io/async-dark.svg)
*Asynchronous read*
...
![Jobs](../../assets/duckdb-asynchronous-io/jobs-light.svg)
![Jobs](../../assets/duckdb-asynchronous-io/jobs-dark.svg)
*Jobs*
...
![Read-ahead cycle](../../assets/duckdb-asynchronous-io/cycle-light.svg)
![Read-ahead cycle](../../assets/duckdb-asynchronous-io/cycle-dark.svg)
*Read-ahead cycle*
...
![Network throughput](../../assets/duckdb-asynchronous-io/q6_network_throughput_3way-light.svg)
![Network throughput](../../assets/duckdb-asynchronous-io/q6_network_throughput_3way-dark.svg)
*Network throughput*
...
> One might notice that the 8 GB result still peaks at 11.5 GB of RSS. This is because [jemalloc](https://duckdb.org/docs/current/internals/jemalloc) keeps recently freed pages resident for about one second so they can be reused. This memory is no longer counted by DuckDB's memory manager, and v1.5.5 shows the same allocator behavior.
