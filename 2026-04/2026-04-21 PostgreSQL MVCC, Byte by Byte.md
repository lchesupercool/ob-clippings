---
title: "PostgreSQL MVCC, Byte by Byte"
source: "https://boringsql.com/posts/postgresql-mvcc-byte-by-byte/"
author: "Radim Marek"
date: "2026-04-17"
clipped_at: "2026-04-21"
tags: [clipping, postgres, mvcc, storage]
---
...
> 
> Drive two concurrent sessions against the same heap page. Watch xmin and xmax stamps change, flip between READ COMMITTED and REPEATABLE READ, trace visibility rules tuple by tuple, and run VACUUM when the dead versions pile up.
> 
> Open Visualizer
...
[[中译-2026-04-21 PostgreSQL MVCC, Byte by Byte]]
