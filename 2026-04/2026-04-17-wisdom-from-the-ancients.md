...
原作者：dongxu  
公众号：我世界的源代码  
发布时间：2026-04-17 13:38  
原文链接：https://mp.weixin.qq.com/s/h5cfR0-crW1BRxAKguNJnw
...
![](../../assets/wechat/2026-04-17-wisdom-from-the-ancients/img-0.png)
...
![](../../assets/wechat/2026-04-17-wisdom-from-the-ancients/img-2.png)

![](../../assets/wechat/2026-04-17-wisdom-from-the-ancients/img-3.png)
...
1About /about gopher.floodgap.com 70
0README /readme.txt gopher.floodgap.com 70
7Search /search gopher.floodgap.com 70
每一行的结构
...
![](../../assets/wechat/2026-04-17-wisdom-from-the-ancients/img-4.png)
...
现在的 Web 很强大，但同时也非常复杂。HTML、CSS、JavaScript 混在一起，很多语义是隐含的。
...
IRC（Internet Relay Chat）是 1988 年由 Jarkko Oikarinen 创建的一种实时文本通信协议。
...
因为 IRC 的文本协议可以扩展（只有少数几个固定的命令），你可以在任何 IRC Server 中提供自己的扩展命令。

基础能力 / 对应的 IRC 命令和概念
命令 / JOIN / PART / PRIVMSG
事件 / message / join / leave
路由 / channel
编码 / 纯文本

![](../../assets/wechat/2026-04-17-wisdom-from-the-ancients/img-6.png)
...
![](../../assets/wechat/2026-04-17-wisdom-from-the-ancients/img-5.jpg)
...
Gopher 把信息组织压缩成层级结构
IRC 把协作压缩成 TCP 的文本消息流

这些设计在当年没有成为主流，很大程度上是因为它们不够“适合人”。但如果用户换成 Agent，情况就有点不一样了。

我不太确定未来的软件形态会是什么样子。但有一种可能是，它不会越来越复杂，而是某种程度上的“回归”。不是回到过去的实现，而是回到那些更简单的抽象。

有些东西，当年看起来太早了。现在可能刚刚好。

P.S. 最后结尾放一张我心目中 90s 赛博朋克美学巅峰，攻壳的草薙素子的经典海报致敬一下，顺便当个题图。

![](../../assets/wechat/2026-04-17-wisdom-from-the-ancients/img-7.jpg)
